...
def second(request):
        ...
        remove_punc=request.POST.get('rum1','off')
        capitalize=request.POST.get('rum2','off')
        space_remover=request.POST.get('rum3','off')
        letter_counter=request.POST.get('rum4','off')
        uppe=''
        rspace=''
        count=''
        r_punc=''
